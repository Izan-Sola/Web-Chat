...
function onMessage(msgc){
           ...
           msgdata = JSON.parse(msgc.data)
            ...
            switch (msgdata.type) {
                ...
                case 'privatemsg':
                    n = msgdata.message.match(/\[([^\]]+)\]/)
                    if (privateMessagesM.has(n[1].trim())) {
                        tempList = privateMessagesM.get(n[1].trim())
                    }
                    ...
                    privateMessagesM.set(n[1].trim(), tempList)
